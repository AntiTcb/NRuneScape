...
namespace NRuneScape.Logging
{
    internal class LogManager
    {
        ...
        {
            Level = minSeverity;
            ClientLogger = new Logger(this, "RuneScape");
        }
        ...
        public async Task WriteInitialLog() 
            => await ClientLogger.InfoAsync($"NRuneScape v{RuneScapeConfig.Version}").ConfigureAwait(false);
    }
}
