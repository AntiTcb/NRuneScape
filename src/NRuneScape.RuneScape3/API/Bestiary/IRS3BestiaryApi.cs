...
namespace NRuneScape.RuneScape3.API
{
    internal interface IRS3BestiaryApi : IRuneScapeApi
    {
        ...
        Task<Response<object>> GetBeastDataAsync([Query] int beastId);

        [Get("m={bestiaryRoute}/beastSearch.json")]
        Task<Response<object[]>> GetBeastSearchAsync([Query] string term);

        [Get("m={bestiaryRoute}/beastiaryNames.json")]
        Task<Response<object[]>> GetBestiaryNamesAsync([Query] char letter);

        [Get("m={bestiaryRoute}/areaNames.json")]
        Task<Response<string[]>> GetAreaNamesAsync();

        [Get("m={bestiaryRoute}/areaBeasts.json")]
        Task<Response<object[]>> GetAreaBeastsAsync([Query] string identifier);
        ...
        Task<Response<object[]>> GetMonstersBySlayerCategoryAsync([Query] int identifier);
        ...
        Task<Response<object[]>> GetMonstersByWeaknessAsync([Query] int identifier);

        [Get("m={bestiaryRoute}/levelGroup.json")]
        Task<Response<object[]>> GetMonstersBetweenLevelsAsync([Query] string identifer);
    }
}
